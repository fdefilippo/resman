...
make deb
# Creates build/deb/resman_1.31.1-2_<architecture>.deb
...
Upgrading any ResMan release from 1.25.x through 1.30.8 to 1.31.1 is intentionally
...
- Upgrade guide from 1.25.x through 1.30.8 to 1.31.1: [`docs/UPGRADING.md`](docs/UPGRADING.md)
