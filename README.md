...
make deb
# Creates build/deb/resman_1.34.0-1_<architecture>.deb
...
Upgrading any ResMan release from 1.25.x through 1.32.0 to 1.34.0 is intentionally
...
- Upgrade guide from 1.25.x through 1.32.0 to 1.34.0: [`docs/UPGRADING.md`](docs/UPGRADING.md)
