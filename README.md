...
make deb
# Creates build/deb/resman_1.35.3-2_<architecture>.deb
...
Upgrading any ResMan release from 1.25.x through 1.34.1 to 1.35.3 is intentionally
...
- Upgrade guide from 1.25.x through 1.34.1 to 1.35.3: [`docs/UPGRADING.md`](docs/UPGRADING.md)
