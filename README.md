...
make deb
# Creates build/deb/resman_1.30.7-2_<architecture>.deb
...
Upgrading from 1.25.x to 1.30.7 is intentionally breaking. Complete the filesystem,
database, configuration, MCP, Prometheus, hook, capability, and container actions in
[`docs/UPGRADING.md`](docs/UPGRADING.md) before installing ResMan 1.30.7.
...
- Upgrade guide from 1.25.x to 1.30.7: [`docs/UPGRADING.md`](docs/UPGRADING.md)
