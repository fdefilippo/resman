	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			required := []string{
				...
				filepath.Join(topdir, "SOURCES", "resman-1.38.0.tar.gz"),
				"cp scripts/sendmail.sh scripts/resman-sendmail-hook.sh scripts/prepare-go-worktree.sh resman-1.38.0/scripts/",
