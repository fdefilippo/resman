...
grep -q "systemctl list-units --all --plain --no-legend 'resmancapprobe\*.slice'" "$script_dir/guest/run-functional.sh"
grep -q "find /sys/fs/cgroup -type d -name 'resmancapprobe\*.slice'" "$script_dir/guest/run-functional.sh"
