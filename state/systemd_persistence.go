...
func (m *Manager) collectSystemdPersistenceInterval(sample *SystemMetrics) {
	...
	system := resmanmetrics.SystemPersistenceMetrics{
		...
		IODeviceWeightEffectQualified: ioWeight.EffectQualified, IODeviceWeightEffectQualificationProvenance: string(ioWeight.EffectQualificationProvenance),
		IODeviceWeightAuthorityCoverage: string(ioWeight.AuthorityCoverage),
