...
var dynamicConfigFields = []string{
	...
	"CPU_QUOTA_NORMAL", "CPU_QUOTA_LIMITED",
	"RAM_LIMIT_ENABLED", "RAM_THRESHOLD", "RAM_RELEASE_THRESHOLD",
	"RAM_QUOTA_LIMITED", "RAM_QUOTA_PER_USER", "DISABLE_SWAP", "RAM_HIGH_RATIO",
...
var restartRequiredConfigFields = []string{
	...
	"METRICS_CACHE_FILE", "PROMETHEUS_FILE",
	...
	"PROMETHEUS_JWT_EXPIRY", "LOG_MAX_SIZE", "USE_SYSLOG", "SERVER_ROLE",
