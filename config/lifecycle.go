...
var dynamicConfigFields = []string{
	...
	"CPU_RESERVE_POINTS", "CPU_ROOT_POINTS", "CPU_BEST_EFFORT_POINTS",
	...
	"IO_WEIGHT_DEVICES", "IO_ROOT_WEIGHT", "IO_DEFAULT_WEIGHT",
	...
	"LOG_LEVEL", "SYSTEM_UID_MIN", "SYSTEM_UID_MAX",
...
var restartRequiredConfigFields = []string{
	...
	"MCP_TLS_MIN_VERSION", "MCP_LOG_LEVEL", "MCP_AUTH_TOKEN", "MCP_EDITOR_AUTH_TOKEN", "MCP_ALLOW_WRITE_OPS",
	"MCP_SHUTDOWN_TIMEOUT",
	"METRICS_DB_ENABLED", "METRICS_DB_PATH", "METRICS_DB_WRITE_INTERVAL",
	"CPU_POINTS_FILE", "IO_USER_WEIGHT_FILE", "LIMIT_HOOK_SCRIPT_USER", "LIMIT_HOOK_SCRIPT_GROUP",
