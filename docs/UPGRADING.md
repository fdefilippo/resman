# Upgrading from ResMan 1.25.x through 1.35.4 to ResMan 1.36.2

Current metrics schema: 7.

This guide applies when moving from any ResMan release from 1.25.x through 1.35.4 to
ResMan 1.36.2. This guide covers the post-1.25.1 audit remediation, the CPU Points
...
ResMan 1.36.2 validates the systemd-native
