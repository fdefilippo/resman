# Upgrading from ResMan 1.25.x through 1.35.4 to ResMan 1.36.3

Current metrics schema: 7.

This guide applies when moving from any ResMan release from 1.25.x through 1.35.4 to
ResMan 1.36.3. This guide covers the post-1.25.1 audit remediation, the CPU Points
...
ResMan 1.36.3 validates the systemd-native
...
weight before it verifies `io.max`; this does not enable weighted-I/O policy or
change the configured strong I/O limits.
